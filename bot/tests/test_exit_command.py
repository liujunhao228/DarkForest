"""Tests for commands/exit.py — .exit 弃权退出当前对局。"""
...
class TestExitCommand:
    async def test_exit_in_game_sends_forfeit(self, in_game_env) -> None:
    ...
    async def test_exit_in_matchmaking_replies_state_error(
        self, in_game_env
    ) -> None:
        bot, ws, pool, mgr, settings = in_game_env
    ...
    async def test_exit_action_error_replies_failure_message(
        ...
        monkeypatch.setattr(exit_mod, "send_game_action", fake_send_game_action)
